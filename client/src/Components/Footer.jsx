  ...
  return (
    <>
      <div className="footer">
        ...
        <div className="join-social">
        <a href="https://github.com/ShivaBhattacharjee/AnimeTrix/" target={"_blank"}><i class="fa-brands fa-telegram"></i></a>
        </div>
        <div className="join-social">
        <a href="https://github.com/ShivaBhattacharjee/AnimeTrix/" target={"_blank"}><ion-icon name="logo-discord"></ion-icon></a>
        </div>
        </div>
      </div>
    </>
